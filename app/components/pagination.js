...
import PaginationItems from '@boilerplate/dashboard/utils/pagination/items';
import arrayRange from '@boilerplate/dashboard/utils/array-range';
...
export default class PaginationComponent extends Component {
    ...
    incrementPage(step = 1) {
        const currentPage = Number(this.args.currentPage),
        ...
        this.currentPage = currentPage + step;
     ...
     * @var {Integer}
     */
    @alias('args.meta.total_pages') totalPages;
     ...
     * @var {Integer}
     */
    @gt('args.meta.total_pages', 1) hasPages;
     ...
     * @var {Boolean}
     */
    @computed('args.meta.current_page', 'totalPages')
    get canStepForward() {
        if (!this.args.meta) {
            return false;
        }
     ...
     * @var {Object}
     */
    @computed('pageItemsObj.pageItems', 'pageItemsObj')
    get pageItems() {
